...
export const get_accessibility_layer = (city, band) => alovaInstance.Get('/getaccessibility', {
    headers: {
        'Content-Type': 'application/json;charset=UTF-8'
    },
...
export const get_city_profile = (city) => alovaInstance.Get('/getsummarybycity', {
    headers: {
        'Content-Type': 'application/json;charset=UTF-8'
    },
...
export const get_closestpark_osm = (cityname, source, pga_size) => alovaInstance.Get('/closestpark_osm', {
    headers: {
        'Content-Type': 'application/json;charset=UTF-8'
    },
...
export const get_greenareas_osm = (cityname) => alovaInstance.Get('/queryosmgreen', {
    headers: {
        'Content-Type': 'application/json;charset=UTF-8'
    },
...
export function newgreen_mindistance_osm(cityname, pga_size, green_code, cell_id) {
    ...
    return new Promise(function (resolve, reject) {
        try {
            ...
            response = fetch('https://atgreen.hpc4ai.unito.it/rpc/newgreen_mindistance_osm?' + params_url);
            resolve(response)
